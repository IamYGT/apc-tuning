						...
						<div class="table-responsive"> 
							<div id="example5_wrapper" class="dataTables_wrapper no-footer">
								<table class="table display mb-4 dataTablesCard card-table dataTable no-footer" id="example5" role="grid" aria-describedby="example5_info">
									<thead>
										<tr role="row"> 
										<th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Date Applied: activate to sort column ascending" style="width: 25%">Car</th>  
										<th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Date Applied: activate to sort column ascending" style="width: 25%">Logo	</th>  
								...
								<div class="row">
									<div class="col-lg-12 mb-2">
										<div class="form-group">
											...
											<input type="text" name="marka" class="form-control" placeholder="Brand" required="">
										</div> 
									</div>
								</div>
								<div class="step-footer pull-right">
									<button type="submit" name="submitControl" value="1" class="step-btn1 btn mr-6 btn-primary">Save</button>
								</div>
							</div>
						</div>
					</div>
 									...
 									<div class="fileinput fileinput-new" data-provides="fileinput">
										...
										<div>
											<span class="btn btn-primary btn-sm btn-file">
												<span class="fileinput-new"><span class="fui-image"></span>Select Logo</span>
                            ...
                            <div class="card-body">   
								<div class="row">
									<div class="col-lg-12 mb-2">
										<div class="form-group">
											<label class="text-label">Brand</label>
											<input type="text" name="marka" class="form-control" placeholder="Brand" required="" value="<?php echo $row_info["marka"]; ?>">
										</div> 
									</div>
								</div>
								<div class="step-footer pull-right">
                        ...
                        <div class="card">
                            <div class="card-body p-3">  	
								...
								<div class="form-group"> 
									<label for="">Status</label>
									<select name="marka_durum" class="form-control">
										<option value="1" <?php if ($row_info["marka_durum"] == "1") { echo "selected";}?>>Active</option>
										<option value="2" <?php if ($row_info["marka_durum"] == "2") { echo "selected";}?>>Passive</option> 
									</select>
								</div> 
                            </div>
                        </div>
