...
?>		
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#site"><i class="las la-wrench mr-2"></i>Website</a>
                                        </li>
										
                                           <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#kurumsal"><i class="la la-archive mr-2"></i>About Us</a>
                                        </li> 
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#sosyal"><i class="la la-user mr-2"></i> Social Media</a>
                                        </li>
																...
																<div class="row">
																	<div class="col-xl-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="">Website Title <span class="text-danger">*</span> </label>
																			<div class="col-lg-8">
																	...
																	<div class="col-xl-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="val-suggestions">Website Address <span class="text-danger">*</span></label>
																			<div class="col-lg-8">
																	...
																	<div class="col-xl-12 mb-3"> 
																		<div class="form-group row">
																			<label class="col-lg-2 col-form-label" for="val-suggestions">Website Description<span class="text-danger">*</span>  </label>
																			<div class="col-lg-10">
																	...
																	<div class="col-lg-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="val-suggestions"> Phone<span class="text-danger">*</span> </label>
																			<div class="col-lg-8">
																	...
																	<div class="col-lg-12 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-2 col-form-label" for="val-suggestions"> E-mail<span class="text-danger">*</span> </label>
																			<div class="col-lg-10">
																	...
																	<div class="col-xl-12 mb-3"> 
																		<div class="form-group row">
																			<label class="col-lg-2 col-form-label" for="val-suggestions">Address<span class="text-danger">*</span> </label>
																			<div class="col-lg-10">
																	...
																	<div class="col-xl-12 mb-3"> 
																		<div class="form-group row">
																			<label class="col-lg-2 col-form-label" for="val-suggestions">Live Chat <span class="text-danger">*</span> </label>
																			<div class="col-lg-10">
																	...
																	<div class="col-lg-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="val-suggestions"> Page Impressions <span class="text-danger">*</span> </label>
																			<div class="col-lg-8">
	...
	?> 
																	<div class="col-xl-12 col-lg-12 mb-3">
																		...
																		<div class="form-group row">
																			<label class="text-label col-3"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>  About Us</label>
	...
	?> 
																	<div class="col-xl-12 col-lg-12 mb-3">
																	 ...
																	 <div class="form-group row">
																			<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Footer About Us</label>
	...
	?> 
																	<div class="col-xl-12 col-lg-12 mb-3">
																		<div class="form-group row">
																			<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Whatsapp Number</label>
																				<div class="input-group  input-primary-o">
																					<div class="input-group-prepend">
																						<span class="input-group-text">+</span>
																					</div>
																	...
																	<div class="col-xl-12 col-lg-12 mb-3">
																		<div class="form-group row">
																			<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Whatsapp Message</label>
																				<div class="input-group input-primary-o">
																					<div class="input-group-prepend">
																						<span class="input-group-text">+</span>
																					</div>
	...
	?>
										...
										<div class="col-xl-12 mb-3">
											<button style="float:right;" type="submit" name="submitControl" value="1" class="btn mr-6 btn-primary">Save</button>
										</div>					
									</form>
                                </div>
                            </div>
