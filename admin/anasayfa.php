							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Daily Unique Hits</p>
						...
						<div class="card bg-success">
							<div class="card-body">	
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Weekly Unique Hits</p>
						...
						<div class="card bg-secondary">
							<div class="card-body">
								...
								<span class="p-3 mr-3 border border-white rounded">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Number of Unique Hits per Month</p>
						...
						<div class="card bg-primary">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">All Times</p>
					...
					<div class="col-xl-12 col-lg-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Monthly Hit Numbers</h4>
                                    </div>
                                    <div class="card-body">
